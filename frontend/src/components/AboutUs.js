    ...
    <section>
        ...
        <div class="container flex flex-col px-4 mx-auto mt-10 md:space-y-0 md:flex-row">
            <div class="flex flex-col justify-center items-center space-x-3 space-y-3 md:w-1/3">
                ...
                <h6 class="text-center text-green text-lg ">PODCAST RECORDING</h6>
            ...
            <div class="flex flex-col justify-center items-center space-x-3 space-y-3 md:w-1/3">
                ...
                <h6 class="text-center text-green text-lg ">CO-WORKING SPACE</h6>
            ...
            <div class="flex flex-col justify-center items-center space-x-3 space-y-3 md:w-1/3">
                ...
                <h6 class="text-center text-green text-lg ">SEATING FOR 4 – 6 PEOPLE</h6>
                <p class="text-md text-gray text-sm">KES 3,000 PER HOUR (EXCLUSIVE VAT)</p>
                <p class="text-md text-gray text-sm">KES 18,000 PER DAY (EXCLUSIVE VAT)</p>
        ...
        <div class="container flex flex-col px-4 mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row">
            <div class="flex flex-col justify-center items-center space-x-3 space-y-3 md:w-1/3">
                ...
                <h6 class="text-center text-green text-lg ">SEATING FOR 6 – 8 PEOPLE</h6>
                <p class="text-md text-gray text-sm">KES 4,000 PER HOUR (EXCLUSIVE VAT)</p>
            ...
            <div class="flex flex-col justify-center items-center space-x-3 space-y-3 md:w-1/3">
                ...
                <h6 class="text-center text-green text-lg ">SEATING FOR 10 – 12 PEOPLE</h6>
                <p class="text-md text-gray text-sm">KES 5,000 PER HOUR (EXCLUSIVE VAT)</p>
            ...
            <div class="flex flex-col justify-center items-center space-x-3 space-y-3 md:w-1/3">
                ...
                <h6 class="text-center text-green text-lg ">SEATING FOR 15 – 25 PEOPLE</h6>
                <p class="text-md text-gray text-sm">KES 10,000 PER HOUR (EXCLUSIVE VAT)</p>
                <p class="text-md text-gray text-sm">KES 60,000 PER DAY (EXCLUSIVE VAT)</p>
                <p class="text-md text-gray text-[10px]">(ANY EXTRA HOUR WILL ATTRACT A COST OF KES 2000 PER HOUR)</p>
            </div>
        </div>
        <div class="flex justify-center my-3 md:justify-center">
        ...
        <div class="container flex flex-col px-4 mx-auto mt-10 md:space-y-0 md:flex-row">
            ...
            <div class="flex flex-col justify-center items-center space-x-3 space-y-3 md:w-1/3">
                ...
                <h6 class="text-center text-green text-lg ">SEATING FOR 4 – 6 PEOPLE</h6>
                <p class="text-md text-gray text-sm">KES 3,000 PER HOUR (EXCLUSIVE VAT)</p>
                <p class="text-md text-gray text-sm">KES 15,000 PER DAY (EXCLUSIVE VAT)</p>
                <p class="text-md text-gray text-[10px]">(ANY EXTRA HOUR WILL ATTRACT A COST OF KES 2000 PER HOUR)</p>
            </div>
        </div>
        <div class="container flex flex-col px-4 mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row">
            ...
            <div class="flex flex-col justify-center items-center space-x-3 space-y-3 md:w-1/3">
                ...
                <h6 class="text-center text-green text-lg ">SEATING FOR 15 – 25 PEOPLE</h6>
                <p class="text-md text-gray text-sm">KES 10,000 PER HOUR (EXCLUSIVE VAT)</p>
                <p class="text-md text-gray text-sm">KES 50,000 PER DAY (EXCLUSIVE VAT)</p>
                <p class="text-md text-gray text-[10px]">(ANY EXTRA HOUR WILL ATTRACT A COST OF KES 2000 PER HOUR)</p>
            </div>
        </div>
        <div class="flex justify-center my-3 md:justify-center">
